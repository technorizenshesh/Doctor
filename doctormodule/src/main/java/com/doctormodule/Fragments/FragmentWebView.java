...
import com.doctormodule.databinding.FragmentDoctorWebViewBinding;
...
public class FragmentWebView extends BottomSheetDialogFragment {
    String title;
    String url;
    private FragmentDoctorWebViewBinding binding;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        binding= DataBindingUtil.inflate(LayoutInflater.from(getActivity()), R.layout.fragment_doctor_web_view,null,false);

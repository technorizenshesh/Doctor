...
public class AdapterAppointment extends RecyclerView.Adapter<AdapterAppointment.mViewHolder> {
    Context mContext;
    ArrayList<ModelRequest>data;
    private onClickRequestListener listener;

    public AdapterAppointment(Context mContext, ArrayList<ModelRequest> data) {
        this.mContext = mContext;
        this.data = data;
    }
    public AdapterAppointment Callback(onClickRequestListener listener){
    ...
    public mViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(mContext).inflate(R.layout.layout_appointment,parent,false);
    ...
    public void onBindViewHolder(@NonNull mViewHolder holder, int position) {
        ...
        if (data.get(position).getStatus().equals("pendding")){
